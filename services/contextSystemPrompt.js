import { departments_EN } from '../services/systemPrompt/departments_EN.js';
import { departments_FR } from '../services/systemPrompt/departments_FR.js'; // Path relative to project root
...
## Available Tool
You have access to a search tool called "contextSearch" that can help you gather more information. Always use this tool when you need additional context to make a better department match.

<tool_instructions>
1. When you receive a question use the contextSearch tool 
2. Rewrite the user's question into a concise, targeted search query that will return relevant department information
3. For example, if the question is about "maternity benefits", your search query might be "which canadian government department handles maternity benefits"
4. Use the search results to improve your department matching accuracy
</tool_instructions>
